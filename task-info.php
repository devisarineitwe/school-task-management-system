    ...
    <div class="modal-dialog add-category-modal">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title text-center">Assign New Activity</h2>
        </div>
              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="datetime-local" min ="<?php echo date('Y-m-d H:i:s');?>" name="t_start_time" id="t_start_time"
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="datetime-local" min="<?php echo date('Y-m-d H:i:s');?>" name="t_end_time" id="t_end_time" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-3">
                      <button type="submit" name="add_task_post" class="btn btn-success-custom">Assign Activity</button>
                    </div>
                    <div class="col-sm-3">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well well-custom">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="btn-group">
                <?php if($user_role == 1){ ?>
                <div class="btn-group">
                  <button class="btn btn-warning btn-menu" data-toggle="modal" data-target="#myModal">Assign New Activity</button>
                </div>
              <?php } ?>
          ...
          <center ><h3>Activity Management Section</h3></center>
          <div class="gap"></div>
